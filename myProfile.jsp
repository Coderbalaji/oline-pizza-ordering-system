...
<div id="myprofileTable">
   ...
   <table border="5" style="background:black">
    ...
    <br><br>
    <div id=plus>
       <a style="color:white" href="ChangePassword.jsp">Change Password</a>
       <br><br>
            <a style="color:white"  href="SignUpServlet?action=logout">Log out</a>
        </div>
</div>
